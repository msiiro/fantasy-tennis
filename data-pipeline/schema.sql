...
CREATE TABLE public.atp_points_reference (
  id integer NOT NULL DEFAULT nextval('atp_points_reference_id_seq'::regclass),
  ...
  CONSTRAINT atp_points_reference_pkey PRIMARY KEY (id)
);
...
CREATE TABLE public.match_points (
  id bigint NOT NULL DEFAULT nextval('match_points_id_seq'::regclass),
  player_id bigint NOT NULL,
  match_id bigint NOT NULL UNIQUE,
  match_date timestamp with time zone,
  points_earned integer NOT NULL DEFAULT 0,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT match_points_pkey PRIMARY KEY (id),
  CONSTRAINT fk_match FOREIGN KEY (match_id) REFERENCES public.tennis_matches(match_id)
);
...
CREATE TABLE public.teams_players (
  id integer NOT NULL DEFAULT nextval('teams_players_id_seq'::regclass),
  team_id bigint,
  player_id bigint,
  ...
  CONSTRAINT teams_players_team_id_fkey FOREIGN KEY (team_id) REFERENCES public.teams(id),
  CONSTRAINT teams_players_player_id_fkey FOREIGN KEY (player_id) REFERENCES public.players(player_id)
);
