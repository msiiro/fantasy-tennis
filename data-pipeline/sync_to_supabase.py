#!/usr/bin/env python3
"""
Sync tennis match data to Supabase (Singles matches only, integer IDs)
"""
...
def sync_all(json_file='tennis_matches.json'):
    """
    Main sync function - coordinates all syncing
    """
    print("=" * 80)
    print("STARTING SUPABASE SYNC (SINGLES ONLY)")
    print("=" * 80)
    ...
    print(f"Tournaments to process: {data['total_tournaments']}")
